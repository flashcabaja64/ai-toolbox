import React, { useState, useRef, forwardRef, createElement, cloneElement } from "react";
...
export const Dropdown = forwardRef(
  (
    ...
    const [isInternalOpen, setInternalOpen] = useState<any>(null);
    ...
    const renderMenu = (menuItem: any, index: number) => {
